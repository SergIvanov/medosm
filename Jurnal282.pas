...
begin
 ...
 ExelTab.Cells.Item[1,15]:='Заключение врачебной комиссии';
...
//  ExelTab.Cells.Item[i,20]:=fDM.qryJurnal282.FieldByName('sostexp').AsString;
  ExelTab.Cells.Item[i,20]:='Кривощекова Ю.В.Тарасова Л.В.Ковалева Н.В. Жесткова Н.А.';
