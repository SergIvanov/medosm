...
//        rec.Codfactor :=qry6c.FieldByName('code').Value;
        ...
        begin
        rec.Naim := 'Периодический медицинский осмотр (ВЭК) работников, обеспечивающих движение поездов (мужчины до 40 лет) - 428';
        rec.naim1 := 'Периодический медицинский осмотр (ВЭК) работников, обеспечивающих движение поездов (мужчины до 40 лет) - 428';
        rec.cena := 3986.2;
        rec.CodPrise :='2.1';
        end;
        ...
        if (qry6c.FieldByName('sex').Value = 'муж') and (qry6c.FieldByName('voz').Value >= 40) then
        begin
        rec.Naim := 'Периодический медицинский осмотр (ВЭК) работников, обеспечивающих движение поездов (мужчины после 40 лет) - 428';
        rec.naim1 := 'Периодический медицинский осмотр (ВЭК) работников, обеспечивающих движение поездов (мужчины после 40 лет) - 428';
        rec.cena := 3986.2;
        rec.CodPrise :='2.2';
        end;
        ...
        begin
        rec.Naim := 'Периодический медицинский осмотр (ВЭК) работников, обеспечивающих движение поездов (женщины до 40 лет) - 428';
        rec.naim1 := 'Периодический медицинский осмотр (ВЭК) работников, обеспечивающих движение поездов (женщины до 40 лет) - 428';
        rec.cena := 4070.76;
        rec.CodPrise :='2.3';
        end;
        ...
        if (qry6c.FieldByName('sex').Value = 'жен') and (qry6c.FieldByName('voz').Value >= 40) then
        begin
        rec.Naim := 'Периодический медицинский осмотр (ВЭК) работников, обеспечивающих движение поездов (женщины после 40 лет) - 428';
        rec.naim1 := 'Периодический медицинский осмотр (ВЭК) работников, обеспечивающих движение поездов (женщины после 40 лет) - 428';
        rec.cena := 4528.18;
        rec.CodPrise :='2.4';
        end;
