...
begin
  ...
  ExelTab.Workbooks.Open[st_in + '\Шаблоны\reestrSogaz.xls'];
  ...
  ExelTab.ActiveWorkbook.SaveAs(st_in + 'Журнал\экономист\Согаз\' +
  ...
  ExelTab.Quit;
  ShellExecute(Self.Handle, 'open', Pchar(st_in + '\Журнал\экономист\Согаз\'),
    nil, nil, SW_SHOWNORMAL);


end;

procedure TFrepSogazPat.btn2Click(Sender: TObject);
begin
